...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/admin_inquiry.css">
</head>
<body>
    <div id="wrapper">
                    ...
                    <div class="chat-sidebar">
                        <div class="inquiry-list-header">
                            <form name="searchForm" action="${pageContext.request.contextPath}/admin/cs/inquiry_list" method="get">
                                <select name="status" onchange="searchList()" class="status-select">
    ...
    <script src="${pageContext.request.contextPath}/dist/js/admin_inquiry.js"></script>
</body>
</html>