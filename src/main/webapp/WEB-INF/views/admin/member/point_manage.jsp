            ...
            <div class="content-container">
                ...
                <div class="card-box mb-4">
                    <h5 class="fw-bold mb-4 d-flex align-items-center">
                        <span class="bg-dark text-white rounded-circle me-2 d-flex align-items-center justify-content-center" style="width:24px; height:24px;">
                    ...
                    <form name="searchForm" action="${pageContext.request.contextPath}/admin/member/point_manage" method="get">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="number" name="minPoint" value="${minPoint}" class="form-control" placeholder="0">
                                    <span class="input-group-text bg-light">~</span>
                                    <input type="number" name="maxPoint" value="${maxPoint}" class="form-control" placeholder="Max">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group input-group-sm">
                                    <select name="condition" class="form-select" style="max-width: 90px;">
                            ...
                            <div class="col-md-2 d-grid">
                                <button type="button" class="btn btn-dark btn-sm fw-bold" onclick="searchList()">SEARCH</button>
                            </div>

                            <div class="col-12 text-center mt-3 border-top pt-3">
                                <button type="button" class="btn btn-outline-secondary btn-sm px-4" onclick="location.href='${pageContext.request.contextPath}/admin/member/point_manage'">
                ...
                <div class="card-box">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <small class="text-muted">Total: <b class="text-orange">${dataCount}</b> members</small>
                        </div>
                        <div class="btn-group-premium">
                            <button type="button" class="btn-ctrl btn-plus" onclick="openPointModal('적립')">
                                <i class="fas fa-plus-circle me-1"></i> 일괄 적립
                            </button>
                            <button type="button" class="btn-ctrl btn-minus" onclick="openPointModal('차감')">
                            ...
                            <tbody>
                                <c:forEach var="dto" items="${list}">
                                    <tr class="text-center">
                                        ...
                                        <td class="text-end pe-5 fw-bold text-orange">
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/admin/member/point_history?memberIdx=${dto.memberIdx}&userId=${dto.userId}" 
                                               class="btn-detail-sm">내역</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                <c:if test="${dataCount == 0}">
                                    <tr><td colspan="8" class="text-center p-5 text-muted">검색된 회원 정보가 없습니다.</td></tr>
                                </c:if>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="modal-body p-4">
                    <form name="pointForm">
                        ...
                        <div class="mb-4">
                            ...
                            <div id="selectedMembers" class="p-3 bg-light border-dashed text-muted small" style="max-height: 120px; overflow-y: auto;">
                            </div>
                            <div class="text-end mt-2">
                                <span class="text-orange fw-bold" id="selectedCount">0</span>명 선택됨
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="reason" class="form-control" placeholder="사유를 입력하세요">
                        </div>

                        <div class="mb-2">
                            <label class="form-label fw-bold">변동 포인트 설정</label>
                            <div class="input-group">
                                <input type="number" name="point_amount" class="form-control text-end fw-bold" placeholder="0">
                                <span class="input-group-text bg-dark text-white border-dark">P</span>
                            </div>
                            <div class="form-text mt-2" id="pointHelp">적립/차감 시 모두 양수로 입력하세요.</div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer border-0 p-4 pt-0">
                    <button type="button" class="btn btn-secondary w-25" data-bs-dismiss="modal">취소</button>
                    <button type="button" class="btn btn-primary flex-grow-1 fw-bold" onclick="submitPointUpdate()">확인</button>
                </div>
            </div>
        </div>
    </div>
