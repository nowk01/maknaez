...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/admin_estimate_write.css">
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="content-container">
                <div class="page-header">
                    ...
                    <p class="page-desc">Official Transaction Statement for Customer</p>
                </div>
                ...
                <div class="estimate-paper">
                    <div class="estimate-header">
                        ...
                        <div style="text-align:right;">
                            <p style="font-weight:700; font-size:14px;">주문번호: ${orderInfo.orderNum}</p>
                            <p style="color:#888; font-size:12px;">발행일자: ${orderInfo.orderDate}</p>
                        </div>
                    </div>
                    ...
                    <div class="info-grid">
                        <div class="info-box">
                            ...
                            <table class="info-table">
                                <tr><th>성함</th><td>${orderInfo.userName}</td></tr>
                                <tr><th>아이디</th><td>${orderInfo.userId}</td></tr>
                                <tr><th>연락처</th><td>${orderInfo.tel}</td></tr>
                                <tr><th>이메일</th><td>${orderInfo.email}</td></tr>
                            </table>
                        </div>
                        <div class="info-box">
                            <h4>발신 (공급자 정보)</h4>
                            ...
                            <c:forEach var="item" items="${list}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div style="font-size:12px; color:#888;">옵션: ${item.pdSize}</div>
                                    </td>
                    ...
                    <div class="total-section">
                        <span class="total-label">합계 금액 (VAT 포함)</span>
                        <span class="total-amount"><fmt:formatNumber value="${orderInfo.totalAmount}" pattern="#,###"/> 원</span>
                    </div>

                    <div class="btn-area">
                        <button type="button" class="btn-print" onclick="printEstimate()">명세서 출력 / PDF 저장</button>
