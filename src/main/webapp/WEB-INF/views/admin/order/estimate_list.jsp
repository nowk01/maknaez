				...
				<div class="card-box">
					<div class="list-header">
						<div style="font-size: 14px; font-weight: 600;">
							신규 주문 <b style="color: #ff4e00;">${waitingCount}</b>건 / 전체 ${dataCount}건
						</div>
					...
					<table class="table">
						...
						<tbody>
							<c:forEach var="dto" items="${list}" varStatus="status">
								<tr>
									<td><input type="checkbox" name="nums" value="${dto.orderNum}"></td>
									<td class="text-muted" style="font-family: 'Montserrat'; font-size:12px;">${dto.orderNum}</td>
									...
									<td><span class="badge-luxury ${dto.status == '결제완료' ? 'st-waiting' : ''}">
											${dto.status} </span></td>
									<td>
							...
							<c:if test="${empty list}">
								<tr>
									<td colspan="9" style="padding: 100px 0; text-align: center;">주문 내역이 없습니다.</td>
								</tr>
							</c:if>
						</tbody>
					</table>
