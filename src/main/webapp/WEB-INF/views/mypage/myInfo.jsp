...
<div class="mypage-container">
    ...
    <main class="main-content">
        ...
        <div id="customer_detail" class="group sm-salomon__details cc-animate-init -in cc-animate-complete">
            ...
            <div class="customer__detailsForm">
                <form name="memberForm" method="post">
                    ...
                    <div class="input-row">
                        ...
                        <input type="text" value="${dto.userId}" disabled>
                    </div>

                    <label class="info-label">이름</label>
                    <div class="divided">
                        <c:set var="uName" value="${dto.userName}" />
                        <input class="divided__input" type="text" placeholder="성" id="last_name_customer" 
                               value="${fn:substring(uName, 0, 1)}">
                        <input class="divided__input" type="text" placeholder="이름" id="first_name_customer" 
                               value="${fn:substring(uName, 1, fn:length(uName))}" required>
                    </div>

                    <div class="input-row">
                        <label class="info-label">생년월일</label>
                        <input type="text" value="<fmt:formatDate value='${dto.birth}' pattern='yyyy/MM/dd'/>" readonly>
                    ...
                    <div class="input-row">
                        ...
                        <input aria-label="이메일" placeholder="이메일" type="email" 
                               name="email" id="email_customer" 
                               value="${dto.email}" size="40">
                    </div>

                    <div class="input-row">
                        <label class="info-label">휴대폰번호</label>
                        <div class="phone-field">
                            <input type="tel" name="tel" value="${dto.tel}" maxlength="11" placeholder="01012341234">
                            <button class="phone-field__send-code" type="button" onclick="sendOTP();">업데이트</button>
                        </div>
                        <div id="otp_sent_msg" class="otp-text hidden">인증번호가 전송되었습니다.</div>
                        <div class="phone-field hidden" id="otp_input_row" style="margin-top:10px;">
                            <input type="text" class="phone-field__input-code" placeholder="인증번호">
                    ...
                    <div class="input-row password-wrap">
                        ...
                        <div class="phone-field">
                            <input type="password" name="userPwd" placeholder="현재 비밀번호를 입력하세요">
                    ...
                    <div class="checkbox-row">
                        <input type="checkbox" id="email_consent" name="receiveEmail" value="1" ${dto.receiveEmail == 1 ? 'checked' : ''}>
                        <label for="email_consent">이메일 수신에 동의합니다</label>
                    </div>
                    <div class="checkbox-row">
                        <input type="checkbox" id="sms_consent" checked>
                        <label for="sms_consent">SMS 수신에 동의합니다.</label>
                    </div>

                    <div class="wide-action">
                        <button type="button" class="as-salomon__submit" onclick="updateMember();">저장</button>
                    </div>
                </form>
            </div>
        </div>
