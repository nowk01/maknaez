...
<main class="login-wrapper">
    ...
    <form name="loginForm" method="post">
        ...
        <div class="login-options slide-item">
            <label>
                <input type="checkbox" name="saveId"> 이메일 저장
            </label>
        ...
        <div class="bottom-links slide-item">
            <a href="${pageContext.request.contextPath}/member/account">간편 회원가입 ></a>
        </div>

        <div class="error-msg slide-item">
            ${message}
        </div>
    </form>
    ...
    <div class="register-section">
        ...
        <h2 class="register-title">아직 회원이 아니신가요?</h2>

        <p class="register-desc">
            회원가입을 통해 다양한 혜택을 누려보세요.
        </p>
